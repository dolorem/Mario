...
class UserInput:
	...
	if (dvorak):
		...
		game.accept("q", self.keyHandler, [";", True])
                game.accept("q-up", self.keyHandler, [";", False])
                game.accept("w", self.keyHandler, [",", True])
                game.accept("w-up", self.keyHandler, [",", False])
                game.accept("e", self.keyHandler, [".", True])
                game.accept("e-up", self.keyHandler, [".", False])
                game.accept("a", self.keyHandler, ["a", True])
                game.accept("a-up", self.keyHandler, ["a", False])
                game.accept("s", self.keyHandler, ["o", True])
                game.accept("s-up", self.keyHandler, ["o", False])
                game.accept("d", self.keyHandler, ["e", True])
                game.accept("d-up", self.keyHandler, ["e", False])
